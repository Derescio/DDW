...
const BackGroundComponent = ({ children }: { children: ReactNode }) => {
  return (
    <>
    <div className="h-screen w-full py-20 bg-white  dark:bg-black   dark:bg-dot-white/[0.6] bg-dot-black/[0.6] absolute top-0 left-0 flex items-center justify-center">
